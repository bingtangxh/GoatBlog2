...
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-19_214726.png)
下图这里就一定要选择“使用现有虚拟磁盘”，如果是 Player 就参照上面折叠内容说的。
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-19_214940.png)
这里注意，浏览虚拟硬盘文件的时候，因为右下角“文件类型”默认只有 vmdk 这一个扩展名，所以你得手动改成“所有文件”。
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-19_215007.png)
同样的， VMW 会询问要不要升级虚拟硬盘格式，咱们这里当然不升级，要不然就不是 vhd 格式了。
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-19_215015.png)
...
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Windows_Server_2012_R2-2026-01-19-21-55-12.png)
等到进桌面之后，只有一件事，打开命令提示符，运行下面这个指令：
`C:\Windows\system32\sysprep\sysprep.exe /oobe /generalize /shutdown`
然后你的这个系统会进行“通用化”操作，然后关机。
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Windows_Server_2012_R2-2026-01-19-21-58-40.png)
...
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-19_074956.png)
下面这里允不允许公用网络访问，我也不确定，就允许吧，难不成一个破 vhd 文件会有什么风险？（哎，话不敢说太满，但是总觉得这里如果禁止了会不会导致额外的麻烦或者错误）
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-19_075520.png)
下图就是存储账户已经创建好了。
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-19_075950.png)
创建大致步骤任意，创建完成后，在左侧单击“数据存储”→“容器”→“添加容器”。
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-19_080124.png)
...
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-19_080918.png)
...
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-20_190456.png)
创建好了之后，将这个 Blob SAS URL 复制下来。
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-20_190646.png)
接着打开资源管理器，会首先看到首页上大大的“入门”。我们单击“附加到资源”。
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-20_190706.png)
...
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-20_190907.png)
然后就是选取要上传的文件，和上传到容器的哪个目录路径里了。可以是根目录，也可以是自己设定的，比如`/vhd/`。目标访问层这个随意了，咱们传上去应该就用一两次然后就删了，所以选成“存档”也问题不大。
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-20_190947.png)
...
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-22_120631.png)
...
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-22_120739.png)
...
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-22_121242.png)
...
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-22_122723.png)
接着是重要的一步，其余设置项目都可以按照你的喜好或者实际可用情况去选择，而“映像”这里一定要“查看所有映像”，然后左侧会有“我的映像”和“共享映像”，如果你刚才创建的是托管映像就选择“我的映像”，如果刚才创建的是共享映像就选择“共享映像”。
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-22_122948.png)
然后应该就能找到你刚才创建的映像了，选取那个映像！

最后要提一嘴的就是 VM 大小和 OS 磁盘规格，对于学生订阅，VM 大小只有 B2ats_v2 和 B1s 是免费的，且最多两台，硬盘只有高级 SSD 64GB P6 才是免费的，总共最多两块，就是不管你虚拟机有几个，硬盘是最多两个。
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-22_123309.png)
上图里就是 B2ats_v2 和 B1s 两种规格虚拟机的比较，而  B2ts_v2 那个不免费，不管他。
![](/_posts/2026/how-to-intsall-windows-server-2012-r2-to-your-azure-vm/Screenshot_2026-01-22_123350.png)
