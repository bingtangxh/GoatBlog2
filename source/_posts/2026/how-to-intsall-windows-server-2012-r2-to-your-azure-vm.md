...
{% asset_img Screenshot_2026-01-19_214726.png %}
下图这里就一定要选择“使用现有虚拟磁盘”，如果是 Player 就参照上面折叠内容说的。
{% asset_img Screenshot_2026-01-19_214940.png %}
这里注意，浏览虚拟硬盘文件的时候，因为右下角“文件类型”默认只有 vmdk 这一个扩展名，所以你得手动改成“所有文件”。
{% asset_img Screenshot_2026-01-19_215007.png %}
同样的， VMW 会询问要不要升级虚拟硬盘格式，咱们这里当然不升级，要不然就不是 vhd 格式了。
{% asset_img Screenshot_2026-01-19_215015.png %}
...
{% asset_img Windows_Server_2012_R2-2026-01-19-21-55-12.png %}
等到进桌面之后，只有一件事，打开命令提示符，运行下面这个指令：
`C:\Windows\system32\sysprep\sysprep.exe /oobe /generalize /shutdown`
然后你的这个系统会进行“通用化”操作，然后关机。
{% asset_img Windows_Server_2012_R2-2026-01-19-21-58-40.png %}
...
{% asset_img Screenshot_2026-01-19_074956.png %}
下面这里允不允许公用网络访问，我也不确定，就允许吧，难不成一个破 vhd 文件会有什么风险？（哎，话不敢说太满，但是总觉得这里如果禁止了会不会导致额外的麻烦或者错误）
{% asset_img Screenshot_2026-01-19_075520.png %}
下图就是存储账户已经创建好了。
{% asset_img Screenshot_2026-01-19_075950.png %}
创建大致步骤任意，创建完成后，在左侧单击“数据存储”→“容器”→“添加容器”。
{% asset_img Screenshot_2026-01-19_080124.png %}
...
{% asset_img Screenshot_2026-01-19_080918.png %}
...
{% asset_img Screenshot_2026-01-20_190456.png %}
创建好了之后，将这个 Blob SAS URL 复制下来。
{% asset_img Screenshot_2026-01-20_190646.png %}
接着打开资源管理器，会首先看到首页上大大的“入门”。我们单击“附加到资源”。
{% asset_img Screenshot_2026-01-20_190706.png %}
...
{% asset_img Screenshot_2026-01-22_120631.png %}
...
{% asset_img Screenshot_2026-01-22_120739.png %}
...
{% asset_img Screenshot_2026-01-22_121242.png %}
...
{% asset_img Screenshot_2026-01-22_123309.png %}
上图里就是 B2ats_v2 和 B1s 两种规格虚拟机的比较，而  B2ts_v2 那个不免费，不管他。
{% asset_img Screenshot_2026-01-22_123350.png %}
